                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {(job.status === 'done' || job.status === 'partial') && (
                    <>
                      ...
                      {job.input?.steps?.includes('audio_full') && parseJobResult(job)?.steps?.['audio_full'] === 'done' && (
                        <button
                      ...
                      {job.input?.steps?.includes('audio_full_translate') && parseJobResult(job)?.steps?.['audio_full_translate'] === 'done' && (
                        <button
                      ...
                      {job.input?.steps?.includes('mindmap') && parseJobResult(job)?.steps?.['mindmap'] === 'done' && (
                        <button
                      ...
                      {job.input?.steps?.includes('inject_epub') && parseJobResult(job)?.steps?.['inject_epub'] === 'done' && (
                        <button
